// Ported directly from classic/scripts/pokedex.js
const NAMES: Record<number, string> = {
  0: ' ', 1: 'Bulbasaur', 2: 'Ivysaur', 3: 'Venusaur',
  4: 'Charmander', 5: 'Charmeleon', 6: 'Charizard',
  7: 'Squirtle', 8: 'Wartotle', 9: 'Blastoise',
  10: 'Caterpie', 11: 'Metapod', 12: 'Butterfree',
  13: 'Weedle', 14: 'Kakuna', 15: 'Beebrill',
  16: 'Pidgey', 17: 'Pidgeoto', 18: 'Pidgeot',
...
export function pokedex(id: number | string): string {
  return NAMES[Number(id)] ?? ' '
}
