...
--
-- Host: 127.0.0.1
-- Generation Time: 18-Fev-2016 às 01:35
...
INSERT INTO `player` (`Id`, `Password`, `Nome`, `Player`, `LvlMax`, `Dinheiro`, `Gym`) VALUES
(0, '$2y$10$Ug2H795nTgtCf/TXBUQZR.URguzT76Y4MXGvJZS1BtI8kirTdMSC.', 'Fiano', 2, 7, 1, 0);
...
INSERT INTO `pokemon` (`Id`, `IdPlayer`, `Pokemon`, `Lvl`, `At1`, `At2`, `At3`, `At4`, `PP1`, `PP2`, `PP3`, `PP4`, `HP`, `XP`, `Slot`) VALUES
(0, 0, 1, 7, 81, 96, 91, 61, 35, 25, 25, 25, 45, 0, 1);
